...
namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public class GWebsiteAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var TraCuuBDS = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_TraCuuBDS, L("TraCuuBDS"));
            TraCuuBDS.CreateChildPermission(GWebsitePermissions.Pages_Administration_TraCuuBDS_Create, L("CreatingNewTraCuuBDS"));
            TraCuuBDS.CreateChildPermission(GWebsitePermissions.Pages_Administration_TraCuuBDS_Edit, L("EditingTraCuuBDS"));
            TraCuuBDS.CreateChildPermission(GWebsitePermissions.Pages_Administration_TraCuuBDS_Delete, L("DeletingTraCuuBDS"));
