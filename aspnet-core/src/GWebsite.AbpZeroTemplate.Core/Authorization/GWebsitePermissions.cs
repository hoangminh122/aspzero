namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public static class GWebsitePermissions
    {
        ...
        public const string Pages_Administration_TraCuuBDS = "Pages.Administration.TraCuuBDS";
        public const string Pages_Administration_TraCuuBDS_Create = "Pages.Administration.TraCuuBDS.Create";
        public const string Pages_Administration_TraCuuBDS_Edit = "Pages.Administration.TraCuuBDS.Edit";
        public const string Pages_Administration_TraCuuBDS_Delete = "Pages.Administration.TraCuuBDS.Delete";
