//import { ViewTraCuuBDSModalComponent } from './view-TraCuuBDS-modal.component';
...
@Component({
    templateUrl: './TraCuuBDS.component.html',
    animations: [appModuleAnimation()]
})
export class TraCuuBDSComponent extends AppComponentBase implements AfterViewInit, OnInit {
